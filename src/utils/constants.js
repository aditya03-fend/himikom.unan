export const DUMMY_ARTICLES = [
  {
    ...
    excerpt: "Pelajari dasar-dasar React Hooks, dua hook paling penting (useState dan useEffect), dan bagaimana mereka mengubah cara kita...",
...
const [count, setCount] = useState(0);
  ...
  },
  {
    ...
    excerpt: "Figma telah menjadi standar industri untuk desain UI/UX. Panduan ini akan memandu Anda melalui fitur-fitur dasarnya...",
    imageUrl: "https://images.unsplash.com/photo-1635776062043-f85b81f337a6?w=400&q=80",
    author: "Divisi UI/UX",
    date: "2025-11-05",
    content: `
