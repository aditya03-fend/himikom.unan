...
void main() {
	...
	`}function i2(s){let e=new WeakMap,i=null;function r(d){if(d&&d.isTexture){const m=d.mapping,p=m===pd||m===md,x=m===Us||m===Ls;if(p||x){let g=e.get(d);const S=g!==void 0?g.texture.pmremVersion:0;if(d.isRenderTargetTexture&&d.pmremVersion!==S)return i===null&&(i=new Bg(s)),g=p?i.fromEquirectangular(d,g):i.fromCubemap(d,g),g.texture.pmremVersion=d.pmremVersion,e.set(d,g),g.texture;if(g!==void 0)return g.texture;{const M=d.image;return p&&M&&M.height>0||x&&M&&l(M)?(i===null&&(i=new Bg(s)),g=p?i.fromEquirectangular(d):i.fromCubemap(d),g.texture.pmremVersion=d.pmremVersion,e.set(d,g),d.addEventListener("dispose",c),g.texture):null}}}return d}function l(d){let m=0;const p=6;for(let x=0;x<p;x++)d[x]!==void 0&&m++;return m===p}function c(d){const m=d.target;m.removeEventListener("dispose",c);const p=e.get(m);p!==void 0&&(e.delete(m),p.dispose())}function h(){e=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:r,dispose:h}}function a2(s){const e={};function i(r){if(e[r]!==void 0)return e[r];const l=s.getExtension(r);return e[r]=l,l}return{has:function(r){return i(r)!==null},init:function(){i("EXT_color_buffer_float"),i("WEBGL_clip_cull_distance"),i("OES_texture_float_linear"),i("EXT_color_buffer_half_float"),i("WEBGL_multisampled_render_to_texture"),i("WEBGL_render_shared_exponent")},get:function(r){const l=i(r);return l===null&&jo("WebGLRenderer: "+r+" extension not supported."),l}}}function r2(s,e,i,r){const l={},c=new WeakMap;function h(g){const S=g.target;S.index!==null&&e.remove(S.index);for(const E in S.attributes)e.remove(S.attributes[E]);S.removeEventListener("dispose",h),delete l[S.id];const M=c.get(S);M&&(e.remove(M),c.delete(S)),r.releaseStatesOfGeometry(S),S.isInstancedBufferGeometry===!0&&delete S._maxInstanceCount,i.memory.geometries--}function d(g,S){return l[S.id]===!0||(S.addEventListener("dispose",h),l[S.id]=!0,i.memory.geometries++),S}function m(g){const S=g.attributes;for(const M in S)e.update(S[M],s.ARRAY_BUFFER)}function p(g){const S=[],M=g.index,E=g.attributes.position;let T=0;if(M!==null){const L=M.array;T=M.version;for(let U=0,P=L.length;U<P;U+=3){const V=L[U+0],N=L[U+1],F=L[U+2];S.push(V,N,N,F,F,V)}}else if(E!==void 0){const L=E.array;T=E.version;for(let U=0,P=L.length/3-1;U<P;U+=3){const V=U+0,N=U+1,F=U+2;S.push(V,N,N,F,F,V)}}else return;const b=new(Nv(S)?Hv:Iv)(S,1);b.version=T;const _=c.get(g);_&&e.remove(_),c.set(g,b)}function x(g){const S=c.get(g);if(S){const M=g.index;M!==null&&S.version<M.version&&p(g)}else p(g);return c.get(g)}return{get:d,update:m,getWireframeAttribute:x}}function s2(s,e,i){let r;function l(S){r=S}let c,h;function d(S){c=S.type,h=S.bytesPerElement}function m(S,M){s.drawElements(r,M,c,S*h),i.update(M,r,1)}function p(S,M,E){E!==0&&(s.drawElementsInstanced(r,M,c,S*h,E),i.update(M,r,E))}function x(S,M,E){if(E===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(r,M,0,c,S,0,E);let b=0;for(let _=0;_<E;_++)b+=M[_];i.update(b,r,1)}function g(S,M,E,T){if(E===0)return;const b=e.get("WEBGL_multi_draw");if(b===null)for(let _=0;_<S.length;_++)p(S[_]/h,M[_],T[_]);else{b.multiDrawElementsInstancedWEBGL(r,M,0,c,S,0,T,0,E);let _=0;for(let L=0;L<E;L++)_+=M[L]*T[L];i.update(_,r,1)}}this.setMode=l,this.setIndex=d,this.render=m,this.renderInstances=p,this.renderMultiDraw=x,this.renderMultiDrawInstances=g}function o2(s){const e={geometries:0,textures:0},i={frame:0,calls:0,triangles:0,points:0,lines:0};function r(c,h,d){switch(i.calls++,h){case s.TRIANGLES:i.triangles+=d*(c/3);break;case s.LINES:i.lines+=d*(c/2);break;case s.LINE_STRIP:i.lines+=d*(c-1);break;case s.LINE_LOOP:i.lines+=d*c;break;case s.POINTS:i.points+=d*c;break;default:sn("WebGLInfo: Unknown draw mode:",h);break}}function l(){i.calls=0,i.triangles=0,i.points=0,i.lines=0}return{memory:e,render:i,programs:null,autoReset:!0,reset:l,update:r}}function l2(s,e,i){const r=new WeakMap,l=new nn;function c(h,d,m){const p=h.morphTargetInfluences,x=d.morphAttributes.position||d.morphAttributes.normal||d.morphAttributes.color,g=x!==void 0?x.length:0;let S=r.get(d);if(S===void 0||S.count!==g){let C=function(){ee.dispose(),r.delete(d),d.removeEventListener("dispose",C)};var M=C;S!==void 0&&S.texture.dispose();const E=d.morphAttributes.position!==void 0,T=d.morphAttributes.normal!==void 0,b=d.morphAttributes.color!==void 0,_=d.morphAttributes.position||[],L=d.morphAttributes.normal||[],U=d.morphAttributes.color||[];let P=0;E===!0&&(P=1),T===!0&&(P=2),b===!0&&(P=3);let V=d.attributes.position.count*P,N=1;V>e.maxTextureSize&&(N=Math.ceil(V/e.maxTextureSize),V=e.maxTextureSize);const F=new Float32Array(V*N*4*g),ee=new Ov(F,V,N,g);ee.type=Oi,ee.needsUpdate=!0;const w=P*4;for(let k=0;k<g;k++){const te=_[k],ce=L[k],he=U[k],pe=V*N*4*k;for(let z=0;z<te.count;z++){const Z=z*w;E===!0&&(l.fromBufferAttribute(te,z),F[pe+Z+0]=l.x,F[pe+Z+1]=l.y,F[pe+Z+2]=l.z,F[pe+Z+3]=0),T===!0&&(l.fromBufferAttribute(ce,z),F[pe+Z+4]=l.x,F[pe+Z+5]=l.y,F[pe+Z+6]=l.z,F[pe+Z+7]=0),b===!0&&(l.fromBufferAttribute(he,z),F[pe+Z+8]=l.x,F[pe+Z+9]=l.y,F[pe+Z+10]=l.z,F[pe+Z+11]=he.itemSize===4?l.w:1)}}S={count:g,texture:ee,size:new ct(V,N)},r.set(d,S),d.addEventListener("dispose",C)}if(h.isInstancedMesh===!0&&h.morphTexture!==null)m.getUniforms().setValue(s,"morphTexture",h.morphTexture,i);else{let E=0;for(let b=0;b<p.length;b++)E+=p[b];const T=d.morphTargetsRelative?1:1-E;m.getUniforms().setValue(s,"morphTargetBaseInfluence",T),m.getUniforms().setValue(s,"morphTargetInfluences",p)}m.getUniforms().setValue(s,"morphTargetsTexture",S.texture,i),m.getUniforms().setValue(s,"morphTargetsTextureSize",S.size)}return{update:c}}function c2(s,e,i,r){let l=new WeakMap;function c(m){const p=r.render.frame,x=m.geometry,g=e.get(m,x);if(l.get(g)!==p&&(e.update(g),l.set(g,p)),m.isInstancedMesh&&(m.hasEventListener("dispose",d)===!1&&m.addEventListener("dispose",d),l.get(m)!==p&&(i.update(m.instanceMatrix,s.ARRAY_BUFFER),m.instanceColor!==null&&i.update(m.instanceColor,s.ARRAY_BUFFER),l.set(m,p))),m.isSkinnedMesh){const S=m.skeleton;l.get(S)!==p&&(S.update(),l.set(S,p))}return g}function h(){l=new WeakMap}function d(m){const p=m.target;p.removeEventListener("dispose",d),i.remove(p.instanceMatrix),p.instanceColor!==null&&i.remove(p.instanceColor)}return{update:c,dispose:h}}const jv=new zn,Vg=new Wv(1,1),Zv=new Ov,Kv=new O1,Qv=new Vv,kg=[],Xg=[],Wg=new Float32Array(16),qg=new Float32Array(9),Yg=new Float32Array(4);function Bs(s,e,i){const r=s[0];if(r<=0||r>0)return s;const l=e*i;let c=kg[l];if(c===void 0&&(c=new Float32Array(l),kg[l]=c),e!==0){r.toArray(c,0);for(let h=1,d=0;h!==e;++h)d+=i,s[h].toArray(c,d)}return c}function gn(s,e){if(s.length!==e.length)return!1;for(let i=0,r=s.length;i<r;i++)if(s[i]!==e[i])return!1;return!0}function vn(s,e){for(let i=0,r=e.length;i<r;i++)s[i]=e[i]}function ou(s,e){let i=Xg[e];i===void 0&&(i=new Int32Array(e),Xg[e]=i);for(let r=0;r!==e;++r)i[r]=s.allocateTextureUnit();return i}function u2(s,e){const i=this.cache;i[0]!==e&&(s.uniform1f(this.addr,e),i[0]=e)}function f2(s,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y)&&(s.uniform2f(this.addr,e.x,e.y),i[0]=e.x,i[1]=e.y);else{if(gn(i,e))return;s.uniform2fv(this.addr,e),vn(i,e)}}function h2(s,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z)&&(s.uniform3f(this.addr,e.x,e.y,e.z),i[0]=e.x,i[1]=e.y,i[2]=e.z);else if(e.r!==void 0)(i[0]!==e.r||i[1]!==e.g||i[2]!==e.b)&&(s.uniform3f(this.addr,e.r,e.g,e.b),i[0]=e.r,i[1]=e.g,i[2]=e.b);else{if(gn(i,e))return;s.uniform3fv(this.addr,e),vn(i,e)}}function d2(s,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z||i[3]!==e.w)&&(s.uniform4f(this.addr,e.x,e.y,e.z,e.w),i[0]=e.x,i[1]=e.y,i[2]=e.z,i[3]=e.w);else{if(gn(i,e))return;s.uniform4fv(this.addr,e),vn(i,e)}}function p2(s,e){const i=this.cache,r=e.elements;if(r===void 0){if(gn(i,e))return;s.uniformMatrix2fv(this.addr,!1,e),vn(i,e)}else{if(gn(i,r))return;Yg.set(r),s.uniformMatrix2fv(this.addr,!1,Yg),vn(i,r)}}function m2(s,e){const i=this.cache,r=e.elements;if(r===void 0){if(gn(i,e))return;s.uniformMatrix3fv(this.addr,!1,e),vn(i,e)}else{if(gn(i,r))return;qg.set(r),s.uniformMatrix3fv(this.addr,!1,qg),vn(i,r)}}function x2(s,e){const i=this.cache,r=e.elements;if(r===void 0){if(gn(i,e))return;s.uniformMatrix4fv(this.addr,!1,e),vn(i,e)}else{if(gn(i,r))return;Wg.set(r),s.uniformMatrix4fv(this.addr,!1,Wg),vn(i,r)}}function g2(s,e){const i=this.cache;i[0]!==e&&(s.uniform1i(this.addr,e),i[0]=e)}function v2(s,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y)&&(s.uniform2i(this.addr,e.x,e.y),i[0]=e.x,i[1]=e.y);else{if(gn(i,e))return;s.uniform2iv(this.addr,e),vn(i,e)}}function _2(s,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z)&&(s.uniform3i(this.addr,e.x,e.y,e.z),i[0]=e.x,i[1]=e.y,i[2]=e.z);else{if(gn(i,e))return;s.uniform3iv(this.addr,e),vn(i,e)}}function S2(s,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z||i[3]!==e.w)&&(s.uniform4i(this.addr,e.x,e.y,e.z,e.w),i[0]=e.x,i[1]=e.y,i[2]=e.z,i[3]=e.w);else{if(gn(i,e))return;s.uniform4iv(this.addr,e),vn(i,e)}}function y2(s,e){const i=this.cache;i[0]!==e&&(s.uniform1ui(this.addr,e),i[0]=e)}function b2(s,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y)&&(s.uniform2ui(this.addr,e.x,e.y),i[0]=e.x,i[1]=e.y);else{if(gn(i,e))return;s.uniform2uiv(this.addr,e),vn(i,e)}}function M2(s,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z)&&(s.uniform3ui(this.addr,e.x,e.y,e.z),i[0]=e.x,i[1]=e.y,i[2]=e.z);else{if(gn(i,e))return;s.uniform3uiv(this.addr,e),vn(i,e)}}function E2(s,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z||i[3]!==e.w)&&(s.uniform4ui(this.addr,e.x,e.y,e.z,e.w),i[0]=e.x,i[1]=e.y,i[2]=e.z,i[3]=e.w);else{if(gn(i,e))return;s.uniform4uiv(this.addr,e),vn(i,e)}}function T2(s,e,i){const r=this.cache,l=i.allocateTextureUnit();r[0]!==l&&(s.uniform1i(this.addr,l),r[0]=l);let c;this.type===s.SAMPLER_2D_SHADOW?(Vg.compareFunction=Lv,c=Vg):c=jv,i.setTexture2D(e||c,l)}function A2(s,e,i){const r=this.cache,l=i.allocateTextureUnit();r[0]!==l&&(s.uniform1i(this.addr,l),r[0]=l),i.setTexture3D(e||Kv,l)}function R2(s,e,i){const r=this.cache,l=i.allocateTextureUnit();r[0]!==l&&(s.uniform1i(this.addr,l),r[0]=l),i.setTextureCube(e||Qv,l)}function C2(s,e,i){const r=this.cache,l=i.allocateTextureUnit();r[0]!==l&&(s.uniform1i(this.addr,l),r[0]=l),i.setTexture2DArray(e||Zv,l)}function w2(s){switch(s){case 5126:return u2;case 35664:return f2;case 35665:return h2;case 35666:return d2;case 35674:return p2;case 35675:return m2;case 35676:return x2;case 5124:case 35670:return g2;case 35667:case 35671:return v2;case 35668:case 35672:return _2;case 35669:case 35673:return S2;case 5125:return y2;case 36294:return b2;case 36295:return M2;case 36296:return E2;case 35678:case 36198:case 36298:case 36306:case 35682:return T2;case 35679:case 36299:case 36307:return A2;case 35680:case 36300:case 36308:case 36293:return R2;case 36289:case 36303:case 36311:case 36292:return C2}}function D2(s,e){s.uniform1fv(this.addr,e)}function U2(s,e){const i=Bs(e,this.size,2);s.uniform2fv(this.addr,i)}function L2(s,e){const i=Bs(e,this.size,3);s.uniform3fv(this.addr,i)}function N2(s,e){const i=Bs(e,this.size,4);s.uniform4fv(this.addr,i)}function O2(s,e){const i=Bs(e,this.size,4);s.uniformMatrix2fv(this.addr,!1,i)}function P2(s,e){const i=Bs(e,this.size,9);s.uniformMatrix3fv(this.addr,!1,i)}function z2(s,e){const i=Bs(e,this.size,16);s.uniformMatrix4fv(this.addr,!1,i)}function F2(s,e){s.uniform1iv(this.addr,e)}function B2(s,e){s.uniform2iv(this.addr,e)}function I2(s,e){s.uniform3iv(this.addr,e)}function H2(s,e){s.uniform4iv(this.addr,e)}function G2(s,e){s.uniform1uiv(this.addr,e)}function V2(s,e){s.uniform2uiv(this.addr,e)}function k2(s,e){s.uniform3uiv(this.addr,e)}function X2(s,e){s.uniform4uiv(this.addr,e)}function W2(s,e,i){const r=this.cache,l=e.length,c=ou(i,l);gn(r,c)||(s.uniform1iv(this.addr,c),vn(r,c));for(let h=0;h!==l;++h)i.setTexture2D(e[h]||jv,c[h])}function q2(s,e,i){const r=this.cache,l=e.length,c=ou(i,l);gn(r,c)||(s.uniform1iv(this.addr,c),vn(r,c));for(let h=0;h!==l;++h)i.setTexture3D(e[h]||Kv,c[h])}function Y2(s,e,i){const r=this.cache,l=e.length,c=ou(i,l);gn(r,c)||(s.uniform1iv(this.addr,c),vn(r,c));for(let h=0;h!==l;++h)i.setTextureCube(e[h]||Qv,c[h])}function j2(s,e,i){const r=this.cache,l=e.length,c=ou(i,l);gn(r,c)||(s.uniform1iv(this.addr,c),vn(r,c));for(let h=0;h!==l;++h)i.setTexture2DArray(e[h]||Zv,c[h])}function Z2(s){switch(s){case 5126:return D2;case 35664:return U2;case 35665:return L2;case 35666:return N2;case 35674:return O2;case 35675:return P2;case 35676:return z2;case 5124:case 35670:return F2;case 35667:case 35671:return B2;case 35668:case 35672:return I2;case 35669:case 35673:return H2;case 5125:return G2;case 36294:return V2;case 36295:return k2;case 36296:return X2;case 35678:case 36198:case 36298:case 36306:case 35682:return W2;case 35679:case 36299:case 36307:return q2;case 35680:case 36300:case 36308:case 36293:return Y2;case 36289:case 36303:case 36311:case 36292:return j2}}class K2{constructor(e,i,r){this.id=e,this.addr=r,this.cache=[],this.type=i.type,this.setValue=w2(i.type)}}class Q2{constructor(e,i,r){this.id=e,this.addr=r,this.cache=[],this.type=i.type,this.size=i.size,this.setValue=Z2(i.type)}}class J2{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,i,r){const l=this.seq;for(let c=0,h=l.length;c!==h;++c){const d=l[c];d.setValue(e,i[d.id],r)}}}const td=/(\w+)(\])?(\[|\.)?/g;function jg(s,e){s.seq.push(e),s.map[e.id]=e}function $2(s,e,i){const r=s.name,l=r.length;for(td.lastIndex=0;;){const c=td.exec(r),h=td.lastIndex;let d=c[1];const m=c[2]==="]",p=c[3];if(m&&(d=d|0),p===void 0||p==="["&&h+2===l){jg(i,p===void 0?new K2(d,s,e):new Q2(d,s,e));break}else{let g=i.map[d];g===void 0&&(g=new J2(d),jg(i,g)),i=g}}}class qc{constructor(e,i){this.seq=[],this.map={};const r=e.getProgramParameter(i,e.ACTIVE_UNIFORMS);for(let l=0;l<r;++l){const c=e.getActiveUniform(i,l),h=e.getUniformLocation(i,c.name);$2(c,h,this)}}setValue(e,i,r,l){const c=this.map[i];c!==void 0&&c.setValue(e,r,l)}setOptional(e,i,r){const l=i[r];l!==void 0&&this.setValue(e,r,l)}static upload(e,i,r,l){for(let c=0,h=i.length;c!==h;++c){const d=i[c],m=r[d.id];m.needsUpdate!==!1&&d.setValue(e,m.value,l)}}static seqWithValue(e,i){const r=[];for(let l=0,c=e.length;l!==c;++l){const h=e[l];h.id in i&&r.push(h)}return r}}function Zg(s,e,i){const r=s.createShader(e);return s.shaderSource(r,i),s.compileShader(r),r}const eT=37297;let tT=0;function nT(s,e){const i=s.split(`
...
`+nT(s.getShaderSource(e),d)}else return c}function aT(s,e){const i=iT(e);return[`vec4 ${s}( vec4 value ) {`,`	return ${i[1]}( vec4( value.rgb * ${i[0]}, value.a ) );`,"}"].join(`
`)}function rT(s,e){let i;switch(e){case o1:i="Linear";break;case l1:i="Reinhard";break;case c1:i="Cineon";break;case u1:i="ACESFilmic";break;case h1:i="AgX";break;case d1:i="Neutral";break;case f1:i="Custom";break;default:ot("WebGLProgram: Unsupported toneMapping:",e),i="Linear"}return"vec3 "+s+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}const Ic=new le;function sT(){Nt.getLuminanceCoefficients(Ic);const s=Ic.x.toFixed(4),e=Ic.y.toFixed(4),i=Ic.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${e}, ${i} );`,"	return dot( weights, rgb );","}"].join(`
...
`)}function cT(s,e){const i={},r=s.getProgramParameter(e,s.ACTIVE_ATTRIBUTES);for(let l=0;l<r;l++){const c=s.getActiveAttrib(e,l),h=c.name;let d=1;c.type===s.FLOAT_MAT2&&(d=2),c.type===s.FLOAT_MAT3&&(d=3),c.type===s.FLOAT_MAT4&&(d=4),i[h]={type:c.type,location:s.getAttribLocation(e,h),locationSize:d}}return i}function Vo(s){return s!==""}function Jg(s,e){const i=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,i).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function $g(s,e){return s.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const uT=/^[ \t]*#include +<([\w\d./]+)>/gm;function Yd(s){return s.replace(uT,hT)}const fT=new Map;function hT(s,e){let i=gt[e];if(i===void 0){const r=fT.get(e);if(r!==void 0)i=gt[r],ot('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,r);else throw new Error("Can not resolve #include <"+e+">")}return Yd(i)}const dT=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function ev(s){return s.replace(dT,pT)}function pT(s,e,i,r){let l="";for(let c=parseInt(e);c<parseInt(i);c++)l+=r.replace(/\[\s*i\s*\]/g,"[ "+c+" ]").replace(/UNROLLED_LOOP_INDEX/g,c);return l}function tv(s){let e=`precision ${s.precision} float;
...
#define LOW_PRECISION`),e}function mT(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===bv?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===Hb?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===ha&&(e="SHADOWMAP_TYPE_VSM"),e}function xT(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Us:case Ls:e="ENVMAP_TYPE_CUBE";break;case au:e="ENVMAP_TYPE_CUBE_UV";break}return e}function gT(s){let e="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case Ls:e="ENVMAP_MODE_REFRACTION";break}return e}function vT(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case Mv:e="ENVMAP_BLENDING_MULTIPLY";break;case r1:e="ENVMAP_BLENDING_MIX";break;case s1:e="ENVMAP_BLENDING_ADD";break}return e}function _T(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const i=Math.log2(e)-2,r=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,i),112)),texelHeight:r,maxMip:i}}function ST(s,e,i,r){const l=s.getContext(),c=i.defines;let h=i.vertexShader,d=i.fragmentShader;const m=mT(i),p=xT(i),x=gT(i),g=vT(i),S=_T(i),M=oT(i),E=lT(c),T=l.createProgram();let b,_,L=i.glslVersion?"#version "+i.glslVersion+`
...
`].filter(Vo).join(`
`)),h=Yd(h),h=Jg(h,i),h=$g(h,i),d=Yd(d),d=Jg(d,i),d=$g(d,i),h=ev(h),d=ev(d),i.isRawShaderMaterial!==!0&&(L=`#version 300 es
...
`)+`
`+_);const U=L+b+h,P=L+_+d,V=Zg(l,l.VERTEX_SHADER,U),N=Zg(l,l.FRAGMENT_SHADER,P);l.attachShader(T,V),l.attachShader(T,N),i.index0AttributeName!==void 0?l.bindAttribLocation(T,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(T,0,"position"),l.linkProgram(T);function F(k){if(s.debug.checkShaderErrors){const te=l.getProgramInfoLog(T)||"",ce=l.getShaderInfoLog(V)||"",he=l.getShaderInfoLog(N)||"",pe=te.trim(),z=ce.trim(),Z=he.trim();let Y=!0,_e=!0;if(l.getProgramParameter(T,l.LINK_STATUS)===!1)if(Y=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(l,T,V,N);else{const ye=Qg(l,V,"vertex"),O=Qg(l,N,"fragment");sn("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(T,l.VALIDATE_STATUS)+`
...
`;class Re{constructor(v){this.props=v||{},this.uniforms=this.props.material?.uniforms,this.scene=null,this.camera=null,this.material=null,this.geometry=null,this.plane=null}init(){this.scene=new Dg,this.camera=new Qc,this.uniforms&&(this.material=new Fc(this.props.material),this.geometry=new Lr(2,2),this.plane=new Ri(this.geometry,this.material),this.scene.add(this.plane))}update(){he.renderer.setRenderTarget(this.props.output||null),he.renderer.render(this.scene,this.camera),he.renderer.setRenderTarget(null)}}class Ve extends Re{constructor(v){super({material:{vertexShader:Y,fragmentShader:O,uniforms:{boundarySpace:{value:v.cellScale},px:{value:v.cellScale},fboSize:{value:v.fboSize},velocity:{value:v.src.texture},dt:{value:v.dt},isBFECC:{value:!0}}},output:v.dst}),this.uniforms=this.props.material.uniforms,this.init()}init(){super.init(),this.createBoundary()}createBoundary(){const v=new Ii,I=new Float32Array([-1,-1,0,-1,1,0,-1,1,0,1,1,0,1,1,0,1,-1,0,1,-1,0,-1,-1,0]);v.setAttribute("position",new Ai(I,3));const K=new Fc({vertexShader:_e,fragmentShader:O,uniforms:this.uniforms});this.line=new aM(v,K),this.scene.add(this.line)}update({dt:v,isBounce:I,BFECC:K}){this.uniforms.dt.value=v,this.line.visible=I,this.uniforms.isBFECC.value=K,super.update()}}class qe extends Re{constructor(v){super({output:v.dst}),this.init(v)}init(v){super.init();const I=new Lr(1,1),K=new Fc({vertexShader:ye,fragmentShader:Ae,blending:ad,depthWrite:!1,uniforms:{px:{value:v.cellScale},force:{value:new ct(0,0)},center:{value:new ct(0,0)},scale:{value:new ct(v.cursor_size,v.cursor_size)}}});this.mouse=new Ri(I,K),this.scene.add(this.mouse)}update(v){const I=z.diff.x/2*v.mouse_force,K=z.diff.y/2*v.mouse_force,fe=v.cursor_size*v.cellScale.x,ne=v.cursor_size*v.cellScale.y,ze=Math.min(Math.max(z.coords.x,-1+fe+v.cellScale.x*2),1-fe-v.cellScale.x*2),Ue=Math.min(Math.max(z.coords.y,-1+ne+v.cellScale.y*2),1-ne-v.cellScale.y*2),Ze=this.mouse.material.uniforms;Ze.force.value.set(I,K),Ze.center.value.set(ze,Ue),Ze.scale.value.set(v.cursor_size,v.cursor_size),super.update()}}class lt extends Re{constructor(v){super({material:{vertexShader:Y,fragmentShader:ue,uniforms:{boundarySpace:{value:v.boundarySpace},velocity:{value:v.src.texture},velocity_new:{value:v.dst_.texture},v:{value:v.viscous},px:{value:v.cellScale},dt:{value:v.dt}}},output:v.dst,output0:v.dst_,output1:v.dst}),this.init()}update({viscous:v,iterations:I,dt:K}){let fe,ne;this.uniforms.v.value=v;for(let ze=0;ze<I;ze++)ze%2===0?(fe=this.props.output0,ne=this.props.output1):(fe=this.props.output1,ne=this.props.output0),this.uniforms.velocity_new.value=fe.texture,this.props.output=ne,this.uniforms.dt.value=K,super.update();return ne}}class Jt extends Re{constructor(v){super({material:{vertexShader:Y,fragmentShader:be,uniforms:{boundarySpace:{value:v.boundarySpace},velocity:{value:v.src.texture},px:{value:v.cellScale},dt:{value:v.dt}}},output:v.dst}),this.init()}update({vel:v}){this.uniforms.velocity.value=v.texture,super.update()}}class ut extends Re{constructor(v){super({material:{vertexShader:Y,fragmentShader:Pe,uniforms:{boundarySpace:{value:v.boundarySpace},pressure:{value:v.dst_.texture},divergence:{value:v.src.texture},px:{value:v.cellScale}}},output:v.dst,output0:v.dst_,output1:v.dst}),this.init()}update({iterations:v}){let I,K;for(let fe=0;fe<v;fe++)fe%2===0?(I=this.props.output0,K=this.props.output1):(I=this.props.output1,K=this.props.output0),this.uniforms.pressure.value=I.texture,this.props.output=K,super.update();return K}}class Rt extends Re{constructor(v){super({material:{vertexShader:Y,fragmentShader:ae,uniforms:{boundarySpace:{value:v.boundarySpace},pressure:{value:v.src_p.texture},velocity:{value:v.src_v.texture},px:{value:v.cellScale},dt:{value:v.dt}}},output:v.dst}),this.init()}update({vel:v,pressure:I}){this.uniforms.velocity.value=v.texture,this.uniforms.pressure.value=I.texture,super.update()}}class H{constructor(v){this.options={iterations_poisson:32,iterations_viscous:32,mouse_force:20,resolution:.5,cursor_size:100,viscous:30,isBounce:!1,dt:.014,isViscous:!1,BFECC:!0,...v},this.fbos={vel_0:null,vel_1:null,vel_viscous0:null,vel_viscous1:null,div:null,pressure_0:null,pressure_1:null},this.fboSize=new ct,this.cellScale=new ct,this.boundarySpace=new ct,this.init()}init(){this.calcSize(),this.createAllFBO(),this.createShaderPass()}getFloatType(){return/(iPad|iPhone|iPod)/i.test(navigator.userAgent)?Pr:Oi}createAllFBO(){const I={type:this.getFloatType(),depthBuffer:!1,stencilBuffer:!1,minFilter:Nn,magFilter:Nn,wrapS:ai,wrapT:ai};for(let K in this.fbos)this.fbos[K]=new ir(this.fboSize.x,this.fboSize.y,I)}createShaderPass(){this.advection=new Ve({cellScale:this.cellScale,fboSize:this.fboSize,dt:this.options.dt,src:this.fbos.vel_0,dst:this.fbos.vel_1}),this.externalForce=new qe({cellScale:this.cellScale,cursor_size:this.options.cursor_size,dst:this.fbos.vel_1}),this.viscous=new lt({cellScale:this.cellScale,boundarySpace:this.boundarySpace,viscous:this.options.viscous,src:this.fbos.vel_1,dst:this.fbos.vel_viscous1,dst_:this.fbos.vel_viscous0,dt:this.options.dt}),this.divergence=new Jt({cellScale:this.cellScale,boundarySpace:this.boundarySpace,src:this.fbos.vel_viscous0,dst:this.fbos.div,dt:this.options.dt}),this.poisson=new ut({cellScale:this.cellScale,boundarySpace:this.boundarySpace,src:this.fbos.div,dst:this.fbos.pressure_1,dst_:this.fbos.pressure_0}),this.pressure=new Rt({cellScale:this.cellScale,boundarySpace:this.boundarySpace,src_p:this.fbos.pressure_0,src_v:this.fbos.vel_viscous0,dst:this.fbos.vel_0,dt:this.options.dt})}calcSize(){const v=Math.max(1,Math.round(this.options.resolution*he.width)),I=Math.max(1,Math.round(this.options.resolution*he.height)),K=1/v,fe=1/I;this.cellScale.set(K,fe),this.fboSize.set(v,I)}resize(){this.calcSize();for(let v in this.fbos)this.fbos[v].setSize(this.fboSize.x,this.fboSize.y)}update(){this.options.isBounce?this.boundarySpace.set(0,0):this.boundarySpace.copy(this.cellScale),this.advection.update({dt:this.options.dt,isBounce:this.options.isBounce,BFECC:this.options.BFECC}),this.externalForce.update({cursor_size:this.options.cursor_size,mouse_force:this.options.mouse_force,cellScale:this.cellScale});let v=this.fbos.vel_1;this.options.isViscous&&(v=this.viscous.update({viscous:this.options.viscous,iterations:this.options.iterations_viscous,dt:this.options.dt})),this.divergence.update({vel:v});const I=this.poisson.update({iterations:this.options.iterations_poisson});this.pressure.update({vel:v,pressure:I})}}class ft{constructor(){this.init()}init(){this.simulation=new H,this.scene=new Dg,this.camera=new Qc,this.output=new Ri(new Lr(2,2),new Fc({vertexShader:Y,fragmentShader:re,transparent:!0,depthWrite:!1,uniforms:{velocity:{value:this.simulation.fbos.vel_0.texture},boundarySpace:{value:new ct},palette:{value:k},bgColor:{value:te}}})),this.scene.add(this.output)}addScene(v){this.scene.add(v)}resize(){this.simulation.resize()}render(){he.renderer.setRenderTarget(null),he.renderer.render(this.scene,this.camera)}update(){this.simulation.update(),this.render()}}class xt{constructor(v){this.props=v,he.init(v.$wrapper),z.init(v.$wrapper),z.autoIntensity=v.autoIntensity,z.takeoverDuration=v.takeoverDuration,this.lastUserInteraction=performance.now(),z.onInteract=()=>{this.lastUserInteraction=performance.now(),this.autoDriver&&this.autoDriver.forceStop()},this.autoDriver=new Z(z,this,{enabled:v.autoDemo,speed:v.autoSpeed,resumeDelay:v.autoResumeDelay,rampDuration:v.autoRampDuration}),this.init(),this._loop=this.loop.bind(this),this._resize=this.resize.bind(this),window.addEventListener("resize",this._resize),this._onVisibility=()=>{document.hidden?this.pause():ee.current&&this.start()},document.addEventListener("visibilitychange",this._onVisibility),this.running=!1}init(){this.props.$wrapper.prepend(he.renderer.domElement),this.output=new ft}resize(){he.resize(),this.output.resize()}render(){this.autoDriver&&this.autoDriver.update(),z.update(),he.update(),this.output.update()}loop(){this.running&&(this.render(),N.current=requestAnimationFrame(this._loop))}start(){this.running||(this.running=!0,this._loop())}pause(){this.running=!1,N.current&&(cancelAnimationFrame(N.current),N.current=null)}dispose(){try{if(window.removeEventListener("resize",this._resize),document.removeEventListener("visibilitychange",this._onVisibility),z.dispose(),he.renderer){const v=he.renderer.domElement;v&&v.parentNode&&v.parentNode.removeChild(v),he.renderer.dispose()}}catch{}}}const vt=U.current;vt.style.position=vt.style.position||"relative",vt.style.overflow=vt.style.overflow||"hidden";const Ie=new xt({$wrapper:vt,autoDemo:M,autoSpeed:E,autoIntensity:T,takeoverDuration:b,autoResumeDelay:_,autoRampDuration:L});P.current=Ie,(()=>{if(!P.current)return;const D=P.current.output?.simulation;if(!D)return;const v=D.options.resolution;Object.assign(D.options,{mouse_force:s,cursor_size:e,isViscous:i,viscous:r,iterations_viscous:l,iterations_poisson:c,dt:h,BFECC:d,resolution:m,isBounce:p}),m!==v&&D.resize()})(),Ie.start();const je=new IntersectionObserver(D=>{const v=D[0],I=v.isIntersecting&&v.intersectionRatio>0;ee.current=I,P.current&&(I&&!document.hidden?P.current.start():P.current.pause())},{threshold:[0,.01,.1]});je.observe(vt),F.current=je;const it=new ResizeObserver(()=>{P.current&&(w.current&&cancelAnimationFrame(w.current),w.current=requestAnimationFrame(()=>{P.current&&P.current.resize()}))});return it.observe(vt),V.current=it,()=>{if(N.current&&cancelAnimationFrame(N.current),V.current)try{V.current.disconnect()}catch{}if(F.current)try{F.current.disconnect()}catch{}P.current&&P.current.dispose(),P.current=null}},[d,e,h,p,i,c,l,s,m,r,x,M,E,T,b,_,L]),me.useEffect(()=>{const C=P.current;if(!C)return;const k=C.output?.simulation;if(!k)return;const te=k.options.resolution;Object.assign(k.options,{mouse_force:s,cursor_size:e,isViscous:i,viscous:r,iterations_viscous:l,iterations_poisson:c,dt:h,BFECC:d,resolution:m,isBounce:p}),C.autoDriver&&(C.autoDriver.enabled=M,C.autoDriver.speed=E,C.autoDriver.resumeDelay=_,C.autoDriver.rampDurationMs=L*1e3,C.autoDriver.mouse&&(C.autoDriver.mouse.autoIntensity=T,C.autoDriver.mouse.takeoverDuration=b)),m!==te&&k.resize()},[s,e,i,r,l,c,h,d,m,p,M,E,T,b,_,L]),Se.jsx("div",{ref:U,className:`w-full h-full relative overflow-hidden pointer-events-none touch-none ${S||""}`,style:g})}const JT=()=>{const s=Fn.c(2);let e;s[0]===Symbol.for("react.memo_cache_sentinel")?(e={width:"100%",height:"100vh",position:"fixed",inset:"0",zIndex:"-10",background:"#000000"},s[0]=e):e=s[0];let i;return s[1]===Symbol.for("react.memo_cache_sentinel")?(i=Se.jsx("div",{style:e,children:Se.jsx(QT,{colors:["#5227FF","#27acff","#b8e4ff"],mouseForce:20,cursorSize:100,isViscous:!1,viscous:30,iterationsViscous:32,iterationsPoisson:32,resolution:.5,isBounce:!1,autoDemo:!0,autoSpeed:.5,autoIntensity:2.2,takeoverDuration:.25,autoResumeDelay:3e3,autoRampDuration:.6})}),s[1]=i):i=s[1],i},$T=s=>{const e=Fn.c(6),{children:i}=s;let r;e[0]===Symbol.for("react.memo_cache_sentinel")?(r=Se.jsx(eA,{}),e[0]=r):r=e[0];let l;e[1]!==i?(l=Se.jsx("main",{className:"",children:i}),e[1]=i,e[2]=l):l=e[2];let c;e[3]===Symbol.for("react.memo_cache_sentinel")?(c=Se.jsx(aA,{}),e[3]=c):c=e[3];let h;return e[4]!==l?(h=Se.jsxs("div",{className:"min-h-screen flex flex-col",children:[r,l,c]}),e[4]=l,e[5]=h):h=e[5],h};function eA(){const s=Fn.c(16),[e,i]=me.useState(!1);let r;s[0]===Symbol.for("react.memo_cache_sentinel")?(r=[{to:"/",label:"Beranda"},{to:"/tentang-kami",label:"Tentang Kami"},{to:"/artikel",label:"Artikel"},{to:"/portfolio",label:"Portfolio"},{to:"/modul",label:"Modul"}],s[0]=r):r=s[0];const l=r;let c;s[1]===Symbol.for("react.memo_cache_sentinel")?(c=Se.jsx("div",{className:"font-semibold text-2xl",children:"Himikom"}),s[1]=c):c=s[1];let h;s[2]===Symbol.for("react.memo_cache_sentinel")?(h=Se.jsx("ul",{className:"hidden md:flex gap-8 text-sm",children:l.map(nA)}),s[2]=h):h=s[2];let d;s[3]!==e?(d=()=>i(!e),s[3]=e,s[4]=d):d=s[4];let m,p,x;s[5]===Symbol.for("react.memo_cache_sentinel")?(m=Se.jsx("span",{className:"w-6 h-0.5 bg-white"}),p=Se.jsx("span",{className:"w-6 h-0.5 bg-white"}),x=Se.jsx("span",{className:"w-6 h-0.5 bg-white"}),s[5]=m,s[6]=p,s[7]=x):(m=s[5],p=s[6],x=s[7]);let g;s[8]!==d?(g=Se.jsxs("nav",{className:`fixed z-[101] top-4 left-1/2 -translate-x-1/2 w-[90%] md:w-[80%]\r
    ...
    `;let h;e[0]!==i?(h=Se.jsx("h2",{className:`\r
      ...
      `,children:[i,Se.jsxs("div",{className:"md:w-1/2 animate-fade-in-up",children:[" ",Se.jsx(lp,{title:"Profil"}),Se.jsx("p",{className:`\r
        ...
        mb-4 \r
        shadow-inner\r
      `,children:Se.jsx("img",{src:c,alt:h,className:"w-full h-full rounded-2xl object-cover transition-transform duration-300 group-hover:scale-105"})}),e[0]=c,e[1]=h,e[2]=d):d=e[2];const m=r||"Judul Program";let p;e[3]!==m?(p=Se.jsx("h3",{className:`\r
        text-xl font-bold \r
      ...
      `,children:m}),e[3]=m,e[4]=p):p=e[4];const x=l||"Deskripsi singkat program akan muncul di sini...";let g;e[5]!==x?(g=Se.jsx("p",{className:`\r
        text-text-secondary-light dark:text-text-secondary-dark \r
        mb-4 \r
      `,children:x}),e[5]=x,e[6]=g):g=e[6];let S;e[7]===Symbol.for("react.memo_cache_sentinel")?(S=Se.jsx("div",{className:"mt-2 w-full flex justify-end",children:Se.jsx(eu,{children:"More"})}),e[7]=S):S=e[7];let M;return e[8]!==d||e[9]!==p||e[10]!==g?(M=Se.jsxs("div",{className:`\r
      p-4 \r
      flex flex-col \r
      h-full \r
      transition-all duration-300 \r
    ...
    `,children:[d,p,g,S]}),e[8]=d,e[9]=p,e[10]=g,e[11]=M):M=e[11],M},fA=[{id:1,title:"HIMIKOM DevClass",description:"Kelas intensif mingguan untuk belajar pengembangan web modern (React, Node.js) dari dasar hingga mahir bersama mentor.",imageUrl:"https://images.unsplash.com/photo-1542831371-29b0f74f9713?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3wzNTU4fDB8MXxzZWFyY2h8NHx8cHJvZ3JhbW1pbmd8ZW58MHx8fHwxNzMyMzEyNDY5&ixlib=rb-4.0.3&q=80&w=400",link:"/portfolio/devclass"},{id:2,title:"UI/UX Workshop",description:"Pelatihan desain antarmuka dan pengalaman pengguna, berfokus pada studi kasus nyata dan penggunaan alat desain seperti Figma.",imageUrl:"https://images.unsplash.com/photo-1581291518857-4e27b48ff24e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3wzNTU4fDB8MXxzZWFyY2h8N3x8dWklMjB1eCUyMGRlc2lnbnxlbnwwfHx8fDE3MzIzMTI1MjA&ixlib=rb-4.0.3&q=80&w=400",link:"/portfolio/workshop-uiux"},{id:3,title:"E-Sports Tournament",description:"Kompetisi e-sports tahunan untuk menjalin silaturahmi antar mahasiswa dan mengasah kemampuan kompetitif.",imageUrl:"https://images.unsplash.com/photo-1542751371-adc38448a05e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3wzNTU4fDB8MXxzZWFyY2h8Mnx8ZSUyMHNwb3J0c3xlbnwwfHx8fDE3MzIzMTI1NDU&ixlib=rb-4.0.3&q=80&w=400",link:"/portfolio/esports"}],hA=()=>{const s=Fn.c(2);let e;s[0]===Symbol.for("react.memo_cache_sentinel")?(e=Se.jsx("div",{className:"w-full fles justify-start",children:Se.jsx(lp,{title:"Program Kami"})}),s[0]=e):e=s[0];let i;return s[1]===Symbol.for("react.memo_cache_sentinel")?(i=Se.jsxs("section",{className:"container flex flex-col mx-auto px-4 sm:px-6 lg:px-8 py-16 gap-6",children:[e,Se.jsx("div",{className:`\r
      ...
      `,children:m}),e[3]=m,e[4]=p):p=e[4];const x=l||"Sub-Judul Program";let g;e[5]!==x?(g=Se.jsx("h3",{className:`\r
        ...
        text-gray-400\r
        mb-2\r
      `,children:x}),e[5]=x,e[6]=g):g=e[6];let S;e[7]===Symbol.for("react.memo_cache_sentinel")?(S=Se.jsx("div",{className:"mt-2 w-full flex justify-end",children:Se.jsxs(eu,{className:"flex items-center gap-2",children:["Visit",Se.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",className:"w-5 h-5",viewBox:"0 0 24 24",children:Se.jsxs("g",{fill:"none",children:[Se.jsx("path",{d:"m12.593 23.258l-.011.002l-.071.035l-.02.004l-.014-.004l-.071-.035q-.016-.005-.024.005l-.004.01l-.017.428l.005.02l.01.013l.104.074l.015.004l.012-.004l.104-.074l.012-.016l.004-.017l-.017-.427q-.004-.016-.017-.018m.265-.113l-.013.002l-.185.093l-.01.01l-.003.011l.018.43l.005.012l.008.007l.201.093q.019.005.029-.008l.004-.014l-.034-.614q-.005-.018-.02-.022m-.715.002a.02.02 0 0 0-.027.006l-.006.014l-.034.614q.001.018.017.024l.015-.002l.201-.093l.01-.008l.004-.011l.017-.43l-.003-.012l-.01-.01z"}),Se.jsx("path",{fill:"#fff",d:"M16 3a5 5 0 0 1 5 5v8a5 5 0 0 1-5 5H8a5 5 0 0 1-5-5V8a5 5 0 0 1 5-5zm-4 5a4 4 0 1 0 0 8a4 4 0 0 0 0-8m0 2a2 2 0 1 1 0 4a2 2 0 0 1 0-4m4.5-3.5a1 1 0 1 0 0 2a1 1 0 0 0 0-2"})]})})]})}),e[7]=S):S=e[7];let M;return e[8]!==d||e[9]!==p||e[10]!==g?(M=Se.jsxs("div",{className:`\r
      p-4 \r
      flex flex-col \r
      h-full \r
      transition-all duration-300 \r
